...
export const SparklesIcon: React.FC<IconProps> = ({ className = 'w-5 h-5' }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="2">
        <path strokeLinecap="round" strokeLinejoin="round" d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.293 2.293a1 1 0 010 1.414L13 12l-1.293 1.293a1 1 0 01-1.414 0L8 10.414a1 1 0 010-1.414L10.293 6.707a1 1 0 011.414 0L13 8l2.293-2.293a1 1 0 011.414 0L19 8m-6 13l2.293-2.293a1 1 0 010-1.414L13 16l-1.293-1.293a1 1 0 01-1.414 0L8 17.586a1 1 0 010 1.414L10.293 21.293a1 1 0 011.414 0L13 20l2.293 2.293a1 1 0 011.414 0L19 20" />
    </svg>
);
